...
int esp_wifi_set_sta_key_internal(int alg, uint8_t *addr, int key_idx, int set_tx,
                                  uint8_t *seq, size_t seq_len, uint8_t *key, size_t key_len, int key_entry_valid);
int  esp_wifi_get_sta_key_internal(uint8_t *ifx, int *alg, uint8_t *addr, int *key_idx,
...
void esp_wifi_set_sta_gtk_index_internal(uint8_t valid, uint8_t index);
int esp_wifi_register_tx_cb_internal(wifi_tx_cb_t fn, uint8_t id);
